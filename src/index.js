...
text.addEventListener("input", function() {
  ...
  document.querySelector("li.estilo1:nth-child(1)").innerHTML ="Palabras: "+ words

  const characterCount = analyzer.getCharacterCount(text.value);
  document.querySelector("li.estilo1:nth-child(2)").innerHTML = "Caracteres: " + characterCount

  const characterExcluSpaces = analyzer.getCharacterCountExcludingSpaces(text.value);
  document.querySelector("li.estilo1:nth-child(3)").innerHTML="Caracteres Sin Espacio: "+ characterExcluSpaces

  const textWordLenght = analyzer.getAverageWordLength(text.value);
  document.querySelector("li.estilo2:nth-child(4)").innerHTML = "Promedio Longitud: " + textWordLenght;
...
function resetMetricas(){
  ...
  document.querySelector("li.estilo1:nth-child(1)").innerHTML ="Palabras: ";
  document.querySelector("li.estilo1:nth-child(2)").innerHTML = "Caracteres: ";
  document.querySelector("li.estilo1:nth-child(3)").innerHTML="Caracteres Sin Espacio: ";
  document.querySelector("li.estilo2:nth-child(4)").innerHTML = "Promedio Longitud: ";
  document.querySelector("li.estilo2:nth-child(5)").innerHTML = "Números: ";
  document.querySelector("li.estilo2:nth-child(6)").innerHTML = "Suma Números: ";
}